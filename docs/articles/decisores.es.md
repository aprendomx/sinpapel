...
**Plazos que se cumplen solos.** A cada etapa se le asigna un tiempo máximo. Si se vence, el sistema actúa automáticamente: notifica al responsable, escala el expediente al siguiente nivel o lo resuelve en el sentido que la institución configure. Los tiempos de respuesta dejan de depender de que alguien revise una bandeja.
